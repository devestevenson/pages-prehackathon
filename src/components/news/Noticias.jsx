    ...
    <div className='container-Noticia'>
        <div className="container-tarjeta">
            <div className="image-noticia">
             <img src="https://images.unsplash.com/photo-1543269865-cbf427effbad?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="" />
            </div>
            <h3>titulo</h3>
